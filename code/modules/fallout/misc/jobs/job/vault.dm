...
/datum/job/overseer
	...
	access = list(access_captain, access_medical, access_morgue, access_surgery, access_chemistry, access_virology, access_genetics, access_mineral_storeroom, access_engine, access_engine_equip, access_tech_storage, access_maint_tunnels,
									access_external_airlocks, access_construction, access_atmospherics, access_sec_doors, access_security, access_tcomsat,  ) 			//See get_access()
